  ...
  return (
    <div style={{ width: 640, margin: "auto", marginTop: 32, paddingBottom: 32 }}>
      <div style={{ fontSize: 20, padding: 8, fontWeight: "bold", letterSpacing: ".01em" }}>
        <div>
          <code style={{ marginRight: 8 }}>{timeLeft}</code>left until today
        </div>
      </div>
            ...
            <List.Item key={`${id}_${item.uri}_${item.owner}`} style={{ alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <div style={{ display: "flex" }}>
                  ...
                  />
                  <Button style={{ marginLeft: 4 }} onClick={() => transfer(transferToAddresses[id], id)}>
                    Transfer
                  </Button>
                </div>
                <div style={{ display: "flex" }}>
                  {selectedPetValue ? (
                    ...
                    <span style={{ color: "orange", marginTop: 16 }}>Please select one pet to convert</span>
                  )}
                </div>
              </div>
            </List.Item>
